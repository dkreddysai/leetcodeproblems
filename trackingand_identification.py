...
def main():
    ...
    while True:
        ...
        if success:
            ...
            cv2.putText(frame, "Tracked", (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 200, 0), 2)
        else:
            cv2.putText(frame, "Lost", (100, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 200), 2)
